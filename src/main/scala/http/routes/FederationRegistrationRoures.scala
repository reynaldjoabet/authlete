...
abstract class FederationRegistrationRoutes[F[*]: Concurrent](
  ...
  def routes[U]: AuthedRoutes[U, F] = AuthedRoutes.of {
    ...
    /**
      ...
      *
      * @see
      *   <a href="https://openid.net/specs/openid-connect-federation-1_0.html#ClientRegistration"
      *   >OpenID Connect Federation 1.0, 5.1. Client Registration</a> Federation registration
      *   endpoint.
      */
